export default {
  ...
  auth: {
    ...
    emailLabel: 'Email',
    loginAccountLabel: 'Account or email',
    loginAccountPlaceholder: 'Enter your account or email',
    loginAccountRequired: 'Account or email is required',
    invalidLoginAccount: 'Enter a valid account or full email address',
