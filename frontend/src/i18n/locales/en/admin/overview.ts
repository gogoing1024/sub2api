export default {
    ...
    groups: {
      ...
      kiroCache: {
        ...
        sourceMode: 'Cache usage source',
        sourceModeEmulationOnly: 'Emulation only',
        sourceModeUpstreamFirst: 'Upstream first',
        sourceModeHint: 'Emulation only: always report locally emulated cache usage. Upstream first: prefer the real cache usage returned by the upstream account, falling back to emulation when upstream reports none.',
